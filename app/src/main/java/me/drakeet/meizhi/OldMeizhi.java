...
public class OldMeizhi {
    ...
    public static boolean init() {
        List<Meizhi> qList = DataSupport.where("mid = ?", "2015/03/26").find(Meizhi.class);
        if (qList.size() > 0) {
            return true;
        }
        // 以下内容乃自动化生成，大家不用替俺担心~~
        ...
        new Meizhi("2015/06/12", "http://ww2.sinaimg.cn/large/b8b73ba1jw1eszxcwaspxj20dw0hdaby.jpg", 500, 625).save();
        ...
        new Meizhi("2015/06/05", "http://ww2.sinaimg.cn/large/7a8aed7bgw1essxtqxs6jj20mj0tzdhl.jpg", 650, 865).save();
        ...
        new Meizhi("2015/06/01", "http://ww2.sinaimg.cn/large/610dc034jw1esofjv6yihj20ci0m80te.jpg", 100, 178).save();
        new Meizhi("2015/05/29", "http://ww3.sinaimg.cn/large/7a8aed7bgw1esk47n9j93j20hs0qoacp.jpg", 500, 750).save();
        new Meizhi("2015/05/28", "http://ww4.sinaimg.cn/large/610dc034jw1esjt1h7fenj20k00qodh2.jpg", 120, 160).save();
        new Meizhi("2015/05/27", "http://ww1.sinaimg.cn/large/610dc034gw1esinw76flej20hs0hswgm.jpg", 120, 120).save();
        ...
        new Meizhi("2015/05/19", "http://ww3.sinaimg.cn/large/610dc034jw1es9nzszicij20l206umy0.jpg", 640, 246).save();
        ...
        new Meizhi("2015/05/07", "http://ww1.sinaimg.cn/large/610dc034gw1ervje0eqqbj20b40gmjry.jpg", 640, 292).save();
        ...
        new Meizhi("2015/04/10", "http://ww4.sinaimg.cn/large/610dc034gw1er0c2qw79sj20b208nglx.jpg", 398, 311).save();
        ...
        new Meizhi("2015/04/03", "http://ww4.sinaimg.cn/large/610dc034gw1eqs7w8fevjj20lx09dq4r.jpg", 400, 171).save();
        new Meizhi("2015/04/02", "http://ww3.sinaimg.cn/large/610dc034gw1eqr2vp3xtcj20m80m8jwd.jpg", 400, 400).save();
        new Meizhi("2015/04/01", "http://ww3.sinaimg.cn/large/610dc034gw1eqpwhut11hj20o50azq4l.jpg", 640, 291).save();
        new Meizhi("2015/03/31", "http://ww1.sinaimg.cn/large/610dc034gw1eqoq9tb77fj20da05mdgb.jpg", 478, 202).save();
        new Meizhi("2015/03/30", "http://ww2.sinaimg.cn/large/610dc034gw1eqnjfdn45qj20h30mk443.jpg", 450, 594).save();
        new Meizhi("2015/03/26", "http://ww4.sinaimg.cn/large/610dc034jw1eqiv43fl7yj204i04uaa6.jpg", 162, 174).save();
        return true;
    }
